...
import jp.co.run.JhipsterApp;
import jp.co.run.config.Constants;
import jp.co.run.domain.Authority;
import jp.co.run.domain.User;
import jp.co.run.repository.AuthorityRepository;
import jp.co.run.repository.UserRepository;
import jp.co.run.security.AuthoritiesConstants;
import jp.co.run.service.MailService;
import jp.co.run.service.UserService;
import jp.co.run.service.dto.PasswordChangeDTO;
import jp.co.run.service.dto.UserDTO;
import jp.co.run.web.rest.errors.ExceptionTranslator;
import jp.co.run.web.rest.vm.KeyAndPasswordVM;
import jp.co.run.web.rest.vm.ManagedUserVM;
