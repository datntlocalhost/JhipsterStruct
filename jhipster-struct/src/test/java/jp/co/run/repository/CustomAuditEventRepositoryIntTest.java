...
import jp.co.run.config.audit.AuditEventConverter;
import jp.co.run.domain.PersistentAuditEvent;
...
import static jp.co.run.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
